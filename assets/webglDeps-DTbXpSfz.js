import{a as c}from"./ProgramTemplate-CA5zQF5j.js";import{E as h,e as _,o as g,b as y}from"./ProgramTemplate-CA5zQF5j.js";import{R as F,s as v}from"./FramebufferObject-CkXntPfM.js";import{eo as P}from"./index-ycM7R5Uo.js";import{t as l}from"./NestedMap-C3hRTnZR.js";class ${constructor(e){this._rctx=e,this._store=new l}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function p(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function d(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
