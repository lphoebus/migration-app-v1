import{iP as ta,kJ as Q,bd as ra,kI as ze,kO as ia,iu as Ga,gb as Y,bv as z,n5 as Da,al as he,hH as na,kv as se,ba as c,bb as Me,bc as Fa,dd as ie,ej as ja,en as Ve,ep as Ra,eo as Va,aN as Ba,il as Ha,k7 as Wa,kl as Ua,fW as Ya,bP as I,fv as qa,pL as Ja,xE as k,kX as Za,kB as Be,kT as He,c4 as ka,bx as Xa,bW as Ka,fS as Te,g7 as Qa,fV as We,bS as eo,ix as ao}from"./index-CXz_NmzW.js";import{O as oo}from"./InterleavedLayout-AIlKjTIL.js";import{n as w,u as ee,r as Ue,o as Se,t as to,C as ro}from"./ShaderOutput-Bdd80V3g.js";import{n as A,a as M,t as pe}from"./NormalAttribute.glsl-CTTXNEk_.js";import{aY as io,aZ as no,a_ as F,a$ as so,b0 as lo,b1 as co,a8 as le,b2 as uo,b3 as mo,a1 as ho,ad as po,b4 as vo,g as D,k as ae,_ as V,aq as B,b5 as H,b as K,h as $,as as W,r as fo,e as go,b6 as xo,A as R,b7 as bo,ag as sa,d as la,aa as ca,aW as da,ae as wo,v as _e,x as ve,ac as ua,b8 as Mo,q as ce,aL as To,ah as So,ai as Ye,a5 as ye,l as yo,o as E,b9 as p,aK as Ie,a6 as Ee,a7 as de,a2 as Co,ba as No,bb as $o,i as Le,bc as Oo,c as Eo,bd as ma,$ as ue,be as ha,ar as pa,f as va,a as fa,at as ga,ab as me,bf as xa,K as zo,au as _o,ay as Io,F as Lo,az as Ao,aA as Po,aB as Go,av as Do,aw as Fo,ax as jo,z as Ro,B as G,C as m,D as Vo,E as Ce,aC as Bo,N as Ho,ap as Wo,aU as Uo,aD as Yo,O as qo,W as Jo}from"./OutputColorHighlightOID.glsl-Bn5OM8KC.js";import{i as N,a as qe,e as oe,n as te}from"./basicInterfaces-CZwQPxTp.js";import{e as x}from"./VertexAttribute-BfkzOMLV.js";import{B as Ae,g as Pe,f as Zo}from"./renderState-C8BFNKdo.js";import{n as i,t as v}from"./glsl-Cj7KC756.js";import{a as fe}from"./BindType-BBwFZqyN.js";import{i as ge}from"./ShaderBuilder-BObC2ki4.js";import{e as Ge,r as q}from"./mat3f64-B5o_lm6j.js";import{r as Je}from"./mat4f64-q_b6UJoq.js";import"./boundedPlane-C0vC58Pm.js";import"./sphere-DGoAplpr.js";function ko(e){e.vertex.code.add(i`
...
}`),s&&n!==R.None&&(e.include(bo,a),t.uniforms.add(l===fe.Pass?new $("normalTexture",h=>h.textureNormal):new sa("normalTexture",h=>h.textureNormal)),d&&(t.uniforms.add(new la("scale",h=>h.scale??Da)),t.uniforms.add(new F("normalTextureTransformMatrix",h=>h.normalTextureTransformMatrix??q))),t.code.add(i`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
}`))}const aa=z(),L=ia();function pt(e){e.code.add(i`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG) {
...
}`)}function St(e,a){a.hasColorTextureTransform?(e.varyings.add("colorUV","vec2"),e.vertex.uniforms.add(new F("colorTextureTransformMatrix",t=>t.colorTextureTransformMatrix??q)).code.add(i`void forwardColorUV(){
colorUV = (colorTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardColorUV(){}`)}function yt(e,a){a.hasNormalTextureTransform&&a.textureCoordinateType!==R.None?(e.varyings.add("normalUV","vec2"),e.vertex.uniforms.add(new F("normalTextureTransformMatrix",t=>t.normalTextureTransformMatrix??q)).code.add(i`void forwardNormalUV(){
normalUV = (normalTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardNormalUV(){}`)}function Ct(e,a){a.hasEmissionTextureTransform&&a.textureCoordinateType!==R.None?(e.varyings.add("emissiveUV","vec2"),e.vertex.uniforms.add(new F("emissiveTextureTransformMatrix",t=>t.emissiveTextureTransformMatrix??q)).code.add(i`void forwardEmissiveUV(){
emissiveUV = (emissiveTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(i`void forwardEmissiveUV(){}`)}function Nt(e,a){a.hasOcclusionTextureTransform&&a.textureCoordinateType!==R.None?(e.varyings.add("occlusionUV","vec2"),e.vertex.uniforms.add(new F("occlusionTextureTransformMatrix",t=>t.occlusionTextureTransformMatrix??q)).code.add(i`void forwardOcclusionUV(){
